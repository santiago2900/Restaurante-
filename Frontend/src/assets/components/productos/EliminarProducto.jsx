...
const EliminarProducto = () => {
  ...
  const cargarProductos = async () => {
    try {
      const response = await fetch('https://fullstack-liart-six.vercel.app/restaurante/productos');
  ...
  const handleEliminar = async () => {
    try {
      const response = await fetch(`https://fullstack-liart-six.vercel.app/restaurante/productos/${selectedProduct}`, {
        method: 'DELETE',
      });
      const data = await response.json();
