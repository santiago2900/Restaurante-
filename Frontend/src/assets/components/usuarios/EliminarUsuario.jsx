...
const EliminarUsuario = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsuarios = async () => {
      try {
        const response = await fetch('https://fullstack-liart-six.vercel.app/restaurante/usuarios');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://fullstack-liart-six.vercel.app/restaurante/usuarios/${selectedUser}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
